...
var.set("Pulchowk")
data = (
"Pulchowk", "Baneswor", "Thapathali", "Maitighar", "Jawlakhel", "Patan", "RNAC", "Satdobato", "Kapan", "Lagankhel")

lbl = Label(window, text="Ambulance GIS System", fg='black', font=("Helvetica", 20), bg='light blue')
lbl.place(x=70, y=20)

lbl1 = Label(window, text=">> Enter your location speed and destination", fg='black', font=("Helvetica", 8),
             bg='light blue')
lbl1.place(x=80, y=100)
lbl2 = Label(window, text=">> See Realtime Traffic at different places", fg='black', font=("Helvetica", 8),
             bg='light blue')
lbl2.place(x=80, y=120)
lbl3 = Label(window, text=">> Get the best path suggested in the map", fg='black', font=("Helvetica", 8),
             bg='light blue')
